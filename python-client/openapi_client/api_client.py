...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ModificationApi()
        api_instance.add_area  # this is an instance of the class Endpoint
        api_instance.add_area()  # this invokes api_instance.add_area.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_area.callable or self.callable in this class
